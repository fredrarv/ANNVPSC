...
C     STRAINR_PROBE=.TRUE.     ! strain rate probing --> hardwired
      STRAINR_PROBE=.FALSE.    ! activate for stress probing 
...
C *********************************************************************
     ...
     #             INDX,INDY
        ...
        NPART = NPROBE/4
        DANG =PI/2.D0/NPART  
        DANG2=DANG/50.        ! APR2020: activate for fine probing
...
C        STANDARD FORM OF NPART = NPROBE/4
C *********************************************************************
...
C        READ (*,*) NPART
C        IF(NPART.GT.6) THEN
C          WRITE(*,*) 'INCREASE DIMENSION OF ACTION & REACTION ARRAYS !'
C          STOP
C        ENDIF
